...
ylim([0,3])
save_plot_with_resolution_svg([pwd '\Figure\'],'SNR_Hipp_all.svg',600)
...
set(gca, 'FontSize', 26 , 'LineWidth', 2, 'TickDir', 'out');
ylim([0,3])
save_plot_with_resolution_svg([pwd '\Figure\'],'SNR_Hipp_ZScoreSign.svg',600)
...
set(gca, 'FontSize', 26 , 'LineWidth', 2, 'TickDir', 'out');
ylim([0,3])
save_plot_with_resolution_svg([pwd '\Figure\'],'SNR_Hipp_ZScorenoSign.svg',600)
...
axis equal
box off
save_plot_with_resolution_svg([pwd '\Figure\'],'Hippo_pie_SNR.svg',600)
%%
clear;clc
cd('E:\MSPaper\Data')
%% Basic Settings
load('Figure1\PFC_SNR.mat')
load('Figure1\PFC_SNR_P.mat')
%% Plot SNR Hippo
set(0, 'DefaultAxesFontName', 'Arial')
set(0, 'DefaultTextFontName', 'Arial')
set(0, 'DefaultAxesFontSize', 14)
...
set(gca, 'FontSize', 26 , 'LineWidth', 2, 'TickDir', 'out');
ylim([0,3])
save_plot_with_resolution_svg([pwd '\Figure\'],'SNR_PFC_all.svg',600)
...
set(gca, 'FontSize', 26 , 'LineWidth', 2, 'TickDir', 'out');
ylim([0,3])
save_plot_with_resolution_svg([pwd '\Figure\'],'SNR_PFC_ZScoreSign.svg',600)
...
set(gca, 'FontSize', 26 , 'LineWidth', 2, 'TickDir', 'out');
ylim([0,3])
save_plot_with_resolution_svg([pwd '\Figure\'],'SNR_PFC_ZScorenoSign.svg',600)
...
axis equal
box off
save_plot_with_resolution_svg([pwd '\Figure\'],'PFC_pie_SNR.svg',600)
